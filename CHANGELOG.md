...
- ARP-spoof MITM mode (`-spoof`) to capture every LAN device's flows, with
  automatic IP-forwarding toggle and ARP-cache restoration on exit.
- Real-time dashboard with devices, top flows, DNS lookups, and a live
  throughput graph.
